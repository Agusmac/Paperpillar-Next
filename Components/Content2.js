    ...
    return (
        <div className='Content2'>
            ...
            <div className={`worksdiv grid grid2fr margincenter  `}>
                ...
                <div className='workback grid gridConCenter'>
                    <div className='margincenter '>
                        <Image src="/images/crisp-works.png" alt="rocket" width={268} height={275} quality={100} />
                    </div>
                </div>
            </div>
            ...
            <div className='worksdiv grid grid2fr margincenter spacerTop3'>
                ...
                <div className='workback tentacle grid gridConCenter'>
                    <div className='margincenter '>
                        {/* <Image src="/images/lifecycle-works.png" alt="tentacles" width={536} height={550}  /> */}
                        <Image src="/images/lifecycle-works.png" alt="tentacles" width={268} height={275} quality={100} />
                    </div>
                </div>
            </div>
