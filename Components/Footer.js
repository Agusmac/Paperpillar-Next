        ...
        <div className='footer grid ' style={{ placeContent: "center" }}>
            <div className='spacerTop3'>
                ...
                <div className='flex footButtons marginCenter textcenter' style={{ justifyContent: "center" }}>
                    <a href="https://github.com/Agusmac" target="_blank" rel="noreferrer"><div><i aria-hidden className="fab fa-github"></i></div></a>
                    <a href="https://www.linkedin.com/in/agustin-mac-rae-3348ab216/" target="_blank" rel="noreferrer"><div><i aria-hidden className="fab fa-linkedin-in"></i></div></a>
                </div>
            </div>
